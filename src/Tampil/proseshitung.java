 ...
 * @author HP
 */
public class proseshitung extends javax.swing.JFrame {

    public prediksi cos= null;
    
    /**
     * Creates new form proseshitung
     */
    public proseshitung() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Jumlah XY");

        jLabel6.setText("Jumlah XX");
...
bil1  = Integer.parseInt(a.getText());
bil2 = Integer.parseInt(b.getText());


hasil = bil1 * bil2;
aa.setText(String.valueOf(hasil));
...
cos.itemterpilih();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        bil1  = Integer.parseInt(c.getText());
        bil2 = Integer.parseInt(d.getText());

        hasil = bil1 * bil1;
        bb.setText(String.valueOf(hasil));

        cos.hslhitungg=hasil;
        cos.itemterpilihh();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proseshitung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proseshitung().setVisible(true);
            }
        });
    }
